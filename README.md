...
- Run the following command to clone the repository:
  ...
  ```bash
  git clone https://github.com/MeoMunDep/bytenova.git
  ```

- After cloning, navigate into the bot's directory:

  ```bash
  cd bytenova/bytenova
  ```
...
```bash
npm install --force user-agents axios meo-forkcy-colors https-proxy-agent socks-proxy-agent ethers web3 crypto-js
```
...
```bash
sudo npm install --force user-agents axios meo-forkcy-colors https-proxy-agent socks-proxy-agent ethers web3 
```
...
- **Fields Explained:**
  ...
  - `changeAvatar`: Enable change avatar feature.
  - `updateName`: Enable update name feature
...
- **Support me via** [Referral Link](https://bytenova.ai/rewards?invite_code=tCeYrh8sC)
...
Enjoy using the bot, hope you earn from my scripts! 🚀
